...
export class InitialMigration1760263908570 implements MigrationInterface {
    name = 'InitialMigration1760263908570'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "pull_request_activity" ("team_name" character varying NOT NULL, "project_name" character varying NOT NULL, "repository_name" character varying NOT NULL, "pull_request_number" integer NOT NULL, "who" character varying NOT NULL, "what" character varying NOT NULL, "when" TIMESTAMP NOT NULL, "description" character varying, "view_url" character varying, CONSTRAINT "PK_063766cc1610ec5405ac761e391" PRIMARY KEY ("team_name", "project_name", "repository_name", "pull_request_number"))`);
        await queryRunner.query(`CREATE TABLE "pull_request" ("team_name" character varying NOT NULL, "project_name" character varying NOT NULL, "repository_name" character varying NOT NULL, "pull_request_number" integer NOT NULL, "view_url" character varying NOT NULL, "target_branch" character varying NOT NULL, "created_date" TIMESTAMP NOT NULL, "updated_date" TIMESTAMP NOT NULL, "shared_for_review_date" TIMESTAMP NOT NULL, "initial_commit_date" TIMESTAMP, "last_commit_date" TIMESTAMP, "merged_date" TIMESTAMP NOT NULL, "requested_reviewers_count" integer NOT NULL, "author_comments_count" integer NOT NULL, "diff_rows_added" numeric NOT NULL, "diff_rows_deleted" numeric NOT NULL, "tests_were_touched" boolean NOT NULL, "has_other_human_approval" boolean NOT NULL, "author_role" character varying NOT NULL, "integrity_errors" character varying, "author_id" integer, CONSTRAINT "PK_c002cc79182e25eb46d9ecddd3a" PRIMARY KEY ("team_name", "project_name", "repository_name", "pull_request_number"))`);
        ...
        await queryRunner.query(`ALTER TABLE "pull_request_activity" ADD CONSTRAINT "FK_063766cc1610ec5405ac761e391" FOREIGN KEY ("team_name", "project_name", "repository_name", "pull_request_number") REFERENCES "pull_request"("team_name","project_name","repository_name","pull_request_number") ON DELETE CASCADE ON UPDATE NO ACTION`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "pull_request_activity" DROP CONSTRAINT "FK_063766cc1610ec5405ac761e391"`);
        ...
        await queryRunner.query(`DROP TABLE "pull_request_activity"`);
